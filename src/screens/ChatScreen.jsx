...
import { farazContact } from './chat/mockChatData';

export default function ChatScreen({ token, user, onError }) {
  const [users, setUsers] = useState([]); const [query, setQuery] = useState(''); const [active, setActive] = useState(null); const [premiumOpen, setPremiumOpen] = useState(true);
