...
export default function ChatScreen({ token, user, onError }) {
  ...
  useEffect(() => { getChatUsers(token, query).then(setUsers).catch(onError); }, [query, token, onError]);
