...
export default function AdminDashboardScreen({ token, user, onLogout, onError, themeMode = 'dark' }) {
  ...
  if (active) return <PremiumChatScreen contact={active} user={user} token={token} themeMode={themeMode} onBack={() => { setActive(null); refresh(); }} onError={onError} />;
